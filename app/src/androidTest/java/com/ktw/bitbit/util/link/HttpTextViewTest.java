package com.ktw.bitbit.util.link;
...
public class HttpTextViewTest {
    ...
    public void urlTest() {
        ...
        List<String> matchList = Arrays.asList(
                ...
                "https://www.baidu.com/",
                "https://www.baidu.com/s?wd=中文", // 安卓正则中的\w支持中文，jdk中不支持，
    ...
    @Test
    public void testUrl(){
        String filename =  AndroidDownloadManager.getFileNameByUrl("https://timgsa.baidu.com/timg?image&quality=80&size=b9999_10000&sec=1584598429636&di=f427446464fa7d9432db661c800420bf&imgtype=0&src=http%3A%2F%2Fpic1.zhimg.com%2F50%2Fv2-d90f73dc5a5cd06756ea820b1380aabd_hd.jpg");
