...
public class UserAvatarDao {
    ...
    private UserAvatarDao() {
        try {
            OrmLiteSqliteOpenHelper helper = OpenHelperManager.getHelper(FLYApplication.getInstance(), SQLiteHelper.class);
    ...
    public void deleteUserAvatar(String userId){
        DeleteBuilder<UserAvatar, String> builder = userDao.deleteBuilder();
        try {
