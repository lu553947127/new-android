...
public class LabelDao {
    ...
    private LabelDao() {
        try {
            labelDao = DaoManager.createDao(OpenHelperManager.getHelper(FLYApplication.getInstance(), SQLiteHelper.class).getConnectionSource(),
                    Label.class);
    ...
    // 删除标签
    public void deleteLabel(String ownerId ) {
        try {
            DeleteBuilder<Label, Integer> builder = labelDao.deleteBuilder();
