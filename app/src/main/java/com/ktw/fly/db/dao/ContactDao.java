...
public class ContactDao {
    ...
    private ContactDao() {
        try {
            contactDao = DaoManager.createDao(OpenHelperManager.getHelper(FLYApplication.getInstance(), SQLiteHelper.class).getConnectionSource(),
                    Contact.class);
    ...
    // 根据UserId删除该用户的联系人
    public void deleteContact(String ownerId) {
        try {
            DeleteBuilder<Contact, Integer> builder = contactDao.deleteBuilder();
