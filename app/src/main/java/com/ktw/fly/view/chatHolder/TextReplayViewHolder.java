    ...
    public void fillData(ChatMessage message) {
        ...
        if (!TextUtils.isEmpty(message.getObjectId())) {
            ...
            if (replayMessage.getIsEncrypt() == 1) {
                try {
                    String decryptKey = Md5Util.toMD5(FLYAppConfig.apiKey + replayMessage.getTimeSend() + replayMessage.getPacketId());
                    ...
                    FLYReporter.post("解密失败<" + replayMessage.getPacketId() + ">", e);
                }
            }
