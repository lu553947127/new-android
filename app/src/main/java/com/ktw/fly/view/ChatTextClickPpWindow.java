...
import static com.ktw.fly.bean.message.XmppMessage.TYPE_CUSTOM_EMOT;
import static com.ktw.fly.bean.message.XmppMessage.TYPE_EMOT_PACKAGE;
import static com.ktw.fly.bean.message.XmppMessage.TYPE_EXIT_VOICE;
import static com.ktw.fly.bean.message.XmppMessage.TYPE_FILE;
import static com.ktw.fly.bean.message.XmppMessage.TYPE_IMAGE;
import static com.ktw.fly.bean.message.XmppMessage.TYPE_IS_CONNECT_VOICE;
import static com.ktw.fly.bean.message.XmppMessage.TYPE_RED;
import static com.ktw.fly.bean.message.XmppMessage.TYPE_TEXT;
import static com.ktw.fly.bean.message.XmppMessage.TYPE_TRANSFER;
import static com.ktw.fly.bean.message.XmppMessage.TYPE_VIDEO;
import static com.ktw.fly.bean.message.XmppMessage.TYPE_VOICE;
