package com.ktw.fly.view.cjt2325.cameralibrary;
...
import com.ktw.fly.view.cjt2325.cameralibrary.listener.CaptureListener;
import com.ktw.fly.view.cjt2325.cameralibrary.listener.ClickListener;
import com.ktw.fly.view.cjt2325.cameralibrary.listener.ErrorListener;
import com.ktw.fly.view.cjt2325.cameralibrary.listener.JCameraListener;
import com.ktw.fly.view.cjt2325.cameralibrary.listener.TypeListener;
import com.ktw.fly.view.cjt2325.cameralibrary.state.CameraMachine;
import com.ktw.fly.view.cjt2325.cameralibrary.util.FileUtil;
import com.ktw.fly.view.cjt2325.cameralibrary.util.LogUtil;
import com.ktw.fly.view.cjt2325.cameralibrary.util.ScreenUtils;
import com.ktw.fly.view.cjt2325.cameralibrary.view.CameraView;
...
public class JCameraView extends FrameLayout implements CameraInterface.CameraOpenOverCallback, SurfaceHolder
    ...
    public JCameraView(Context context, AttributeSet attrs, int defStyleAttr) {
        ...
        duration = a.getInteger(R.styleable.JCameraView_duration_max, 10 * 1000);       // 默认为10s
        a.recycle();
        initData();
        initView();
    }
    ...
    private void initView() {
        ...
        mCaptureLayout.setCaptureLisenter(new CaptureListener() {
            ...
            public void recordShort(final long time) {
                mCaptureLayout.setTextWithAnimation(getContext().getString(R.string.tip_record_too_short));
        ...
        mCaptureLayout.setMiddleClickListener(new ClickListener() {
            ...
            public void onClick() {
                if (jCameraLisenter != null) {
                    jCameraLisenter.onEditClick(captureBitmap);
                }
            }
        });
    ...
    public void setFeatures(int state) {
        if (state == BUTTON_STATE_ONLY_CAPTURE) {
            this.mCaptureLayout.setTip(getContext().getString(R.string.tip_short_click_take_photo));
        }
