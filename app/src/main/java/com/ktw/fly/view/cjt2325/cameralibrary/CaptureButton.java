...
public class CaptureButton extends View {
    ...
    public boolean onTouchEvent(MotionEvent event) {
        switch (event.getAction()) {
            ...
            case MotionEvent.ACTION_CANCEL:
                // 测试部提到出现过放手无效#4762，以防万一加上ACTION_CANCEL，
    ...
    private void handlerUnpressByState() {
        ...
        switch (state) {
            ...
            case STATE_LONG_PRESS:
                ...
                if (captureLisenter != null) {
                    captureLisenter.recordShort(0);//回调录制时间过短
                }
                break;
            //当前是长按状态
    ...
    private void startCaptureAnimation(float inside_start) {
        if (!UiUtils.isNormalClick(this)) {
            // 避免连续点击连续拍照，可能部分设备会崩溃，
            return;
        }
        ...
        public void run() {
            ...
            if (CheckPermission.getRecordState() != CheckPermission.STATE_SUCCESS) {
                ...
                if (captureLisenter != null) {
                    ...
                    Log.e("onTouchEvent", "没有录制权限: " + CheckPermission.getRecordState());
                    return;
                }
            }
            //启动按钮动画，外圆变大，内圆缩小
