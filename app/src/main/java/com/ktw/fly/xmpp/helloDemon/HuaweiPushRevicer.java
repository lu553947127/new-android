...
public class HuaweiPushRevicer extends PushReceiver {
    ...
    public void onToken(Context context, String token, Bundle extras) {
         ...
         * 得到token,上传至服务器
         */
        String area = PreferenceUtils.getString(context, FLYAppConstant.EXTRA_CLUSTER_AREA);
        ...
        HttpUtils.get().url(CoreManager.requireConfig(FLYApplication.getInstance()).configHw)
                .params(params)
                .build()
