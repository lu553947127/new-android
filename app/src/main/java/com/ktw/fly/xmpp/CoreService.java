...
import com.ktw.fly.bean.SyncBean;
import com.ktw.fly.bean.User;
import com.ktw.fly.bean.message.ChatMessage;
import com.ktw.fly.bean.message.LastChatHistoryList;
...
public class CoreService extends Service {
    ...
    public void sendNewFriendMessage(String toUserId, NewFriendMessage message) {
        ...
        mConnectionManager.sendMessage(com.ktw.fly.socket.msg.ChatMessage.toSocketMessage(chatMessage));
    }
...
*/
    ...
    public void register() {
        ...
        intentFilter.addAction(com.ktw.fly.broadcast.OtherBroadcast.Read);
    ...
    public class ReadBroadcastReceiver extends BroadcastReceiver {
        ...
        public void onReceive(Context context, Intent intent) {
            if (intent.getAction().equals(com.ktw.fly.broadcast.OtherBroadcast.Read)) {
