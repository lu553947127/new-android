...
import com.ktw.fly.call.talk.MessageTalkJoinEvent;
import com.ktw.fly.call.talk.MessageTalkLeftEvent;
import com.ktw.fly.call.talk.MessageTalkOnlineEvent;
import com.ktw.fly.call.talk.MessageTalkReleaseEvent;
import com.ktw.fly.call.talk.MessageTalkRequestEvent;
...
public class XMuChatMessageListener {
    ...
    public void onReceMessage(com.ktw.fly.socket.msg.ChatMessage message, ChatMessage chatMessage, boolean isDelay) {
        String roomJid;
