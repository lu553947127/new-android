package com.ktw.fly.xmpp.helloDemon;
...
public class IntentWrapper {
    ...
    private static String mAppName = FLYApplication.getContext().getString(R.string.app_name);
    ...
    public static List<IntentWrapper> getIntentWrapperList() {
        if (sIntentWrapperList == null) {
            ...
            xiaomiGodIntent.putExtra("package_name", FLYApplication.getInstance().getPackageName());
            ...
            Intent samsungLIntent = FLYApplication.getInstance().getPackageManager().getLaunchIntentForPackage("com.samsung.android.sm");
            ...
            meizuIntent.putExtra("packageName", FLYApplication.getInstance().getPackageName());
    ...
    public static String getApplicationName() {
       /* if (sApplicationName == null) {
        ...
        return FLYApplication.getInstance().getPackageName();
    }
    ...
    public static List<IntentWrapper> whiteListMatters(final Activity a, String reason) {
        ...
        if (reason == null)
            reason = FLYApplication.getContext().getString(R.string.intent_wrapper_reason);
            ...
            switch (iw.type) {
                case HUAWEI:
                    new AlertDialog.Builder(a)
                            .setCancelable(true)
                            .setMessage(reason + FLYApplication.getContext().getString(R.string.intent_wrapper_need_allow) + mAppName + a.getString(R.string.intent_wrapper_1) +
                                    a.getString(R.string.intent_wrapper_2) + getApplicationName() + FLYApplication.getContext().getString(R.string.intent_wrapper_switch_turn_on))
                ...
                case HUAWEI_GOD:
                    new AlertDialog.Builder(a)
                            ...
                            .setMessage(reason + FLYApplication.getContext().getString(R.string.intent_wrapper_need) + mAppName + a.getString(R.string.intent_wrapper_3) +
                                    a.getString(R.string.intent_wrapper_4) + getApplicationName() + FLYApplication.getContext().getString(R.string.intent_wrapper_switch_turn_on))
                            .setPositiveButton(a.getString(R.string.sure), new DialogInterface.OnClickListener() {
                                public void onClick(DialogInterface d, int w) {
                                    iw.startActivitySafely(a);
                                }
                ...
                case XIAOMI_GOD:
                    new AlertDialog.Builder(a)
                            .setCancelable(true)
                            .setMessage(reason + FLYApplication.getContext().getString(R.string.intent_wrapper_need_close) + mAppName + a.getString(R.string.intent_wrapper_5) +
                ...
                case SAMSUNG_L:
                    new AlertDialog.Builder(a)
                            ...
                            .setMessage(reason + FLYApplication.getContext().getString(R.string.intent_wrapper_need) + mAppName + a.getString(R.string.intent_wrapper_8) +
                                    a.getString(R.string.intent_wrapper_9) + getApplicationName() + FLYApplication.getContext().getString(R.string.intent_wrapper_switch_turn_on))
                            .setPositiveButton(a.getString(R.string.sure), new DialogInterface.OnClickListener() {
                                public void onClick(DialogInterface d, int w) {
                                    iw.startActivitySafely(a);
                                }
                ...
                case SAMSUNG_M:
                    new AlertDialog.Builder(a)
                            .setCancelable(true)
                            .setMessage(reason + FLYApplication.getContext().getString(R.string.intent_wrapper_need) + mAppName + a.getString(R.string.intent_wrapper_10) +
                ...
                case MEIZU:
                    new AlertDialog.Builder(a)
                            .setCancelable(true)
                            .setMessage(reason + FLYApplication.getContext().getString(R.string.intent_wrapper_need_allow) + mAppName + a.getString(R.string.intent_wrapper_13) +
                ...
                case MEIZU_GOD:
                    new AlertDialog.Builder(a)
                            ...
                            .setMessage(reason + FLYApplication.getContext().getString(R.string.intent_wrapper_need) + mAppName + a.getString(R.string.intent_wrapper_15) +
                                    a.getString(R.string.intent_wrapper_16) + getApplicationName() + FLYApplication.getContext().getString(R.string.intent_wrapper_switch_turn_on))
                            .setPositiveButton(a.getString(R.string.sure), new DialogInterface.OnClickListener() {
                                public void onClick(DialogInterface d, int w) {
                                    iw.startActivitySafely(a);
                                }
                ...
                case OPPO_OLD:
                    new AlertDialog.Builder(a)
                            .setCancelable(true)
                            .setMessage(reason + FLYApplication.getContext().getString(R.string.intent_wrapper_need) + mAppName + a.getString(R.string.intent_wrapper_17) +
                                    a.getString(R.string.intent_wrapper_18) + getApplicationName() + FLYApplication.getContext().getString(R.string.intent_wrapper_switch_turn_on))
                            .setPositiveButton(a.getString(R.string.sure), new DialogInterface.OnClickListener() {
                                public void onClick(DialogInterface d, int w) {
                                    iw.startActivitySafely(a);
                                }
                ...
                case COOLPAD:
                    new AlertDialog.Builder(a)
                            .setCancelable(true)
                            .setMessage(reason + FLYApplication.getContext().getString(R.string.intent_wrapper_need) + mAppName + a.getString(R.string.intent_wrapper_19) +
                ...
                case VIVO_GOD:
                    new AlertDialog.Builder(a)
                            ...
                            .setMessage(reason + FLYApplication.getContext().getString(R.string.intent_wrapper_need_allow) + mAppName + a.getString(R.string.intent_wrapper_21) +
                                    a.getString(R.string.intent_wrapper_22) + getApplicationName() + FLYApplication.getContext().getString(R.string.intent_wrapper_switch_turn_on))
                            .setPositiveButton(a.getString(R.string.sure), new DialogInterface.OnClickListener() {
                                public void onClick(DialogInterface d, int w) {
                                    iw.startActivitySafely(a);
                                }
                ...
                case GIONEE:
                    new AlertDialog.Builder(a)
                            .setCancelable(true)
                            .setMessage(reason + FLYApplication.getContext().getString(R.string.intent_wrapper_need_allow) + mAppName + a.getString(R.string.intent_wrapper_23) +
                ...
                case LETV_GOD:
                    new AlertDialog.Builder(a)
                            ...
                            .setMessage(reason + FLYApplication.getContext().getString(R.string.intent_wrapper_need_prohibited) + mAppName + a.getString(R.string.intent_wrapper_25) +
                                    a.getString(R.string.intent_wrapper_26) + getApplicationName() + FLYApplication.getContext().getString(R.string.intent_wrapper_switch_turn_off))
                            .setPositiveButton(a.getString(R.string.sure), new DialogInterface.OnClickListener() {
                                public void onClick(DialogInterface d, int w) {
                                    iw.startActivitySafely(a);
                                }
                ...
                case LENOVO:
                    new AlertDialog.Builder(a)
                            .setCancelable(true)
                            .setMessage(reason + FLYApplication.getContext().getString(R.string.intent_wrapper_need_allow) + mAppName + a.getString(R.string.intent_wrapper_27) +
                                    a.getString(R.string.intent_wrapper_28) + getApplicationName() + FLYApplication.getContext().getString(R.string.intent_wrapper_switch_turn_on))
                            .setPositiveButton(a.getString(R.string.sure), new DialogInterface.OnClickListener() {
                                public void onClick(DialogInterface d, int w) {
                                    iw.startActivitySafely(a);
                                }
                ...
                case LENOVO_GOD:
                    new AlertDialog.Builder(a)
                            ...
                            .setMessage(reason + FLYApplication.getContext().getString(R.string.intent_wrapper_need_close) + mAppName + a.getString(R.string.intent_wrapper_29) +
                                    a.getString(R.string.intent_wrapper_30) + getApplicationName() + FLYApplication.getContext().getString(R.string.intent_wrapper_switch_turn_off))
                            .setPositiveButton(a.getString(R.string.sure), new DialogInterface.OnClickListener() {
                                public void onClick(DialogInterface d, int w) {
                                    iw.startActivitySafely(a);
                                }
        ...
        if (showed.size() == 0) {// 说明没有可执行的intent 通知到设置界面
            FLYApplication.getContext().sendBroadcast(new Intent(com.ktw.fly.broadcast.OtherBroadcast.NO_EXECUTABLE_INTENT));
        }
        return showed;
    }
    ...
    protected boolean doesActivityExists() {
        // if (!DaemonEnv.sInitialized)
        // return false;
        PackageManager pm = FLYApplication.getInstance().getPackageManager();
