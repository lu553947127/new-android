...
import com.ktw.fly.ui.circle.util.RefreshListImp;
...
import com.ktw.fly.view.PMsgBottomView;
...
public class BusinessCircleActivity extends BaseActivity implements showCEView, RefreshListImp {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        if (getIntent() != null) {
            mType = getIntent().getIntExtra(FLYAppConstant.EXTRA_CIRCLE_TYPE, FLYAppConstant.CIRCLE_TYPE_MY_BUSINESS);// 默认的为查看我的商务圈
