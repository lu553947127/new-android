...
import com.ktw.fly.bean.NoticeId;
...
import static com.ktw.fly.FLYAppConstant.NOTICE_ID;
import static com.ktw.fly.FLYAppConstant.PROCLAMATION;
                ...
                .execute(new BaseCallback<NoticeId>(NoticeId.class) {
                    ...
                    public void onResponse(ObjectResult<NoticeId> result) {
                        ...
                        if (Result.checkSuccess(mContext, result)) {
                            ...
                            notice.setText(text);
                            if (!TextUtils.isEmpty(result.getData().getNoticeId())) {
