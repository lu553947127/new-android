...
import com.ktw.fly.bean.SKShareBean;
import com.ktw.fly.helper.AvatarHelper;
import com.ktw.fly.helper.DialogHelper;
import com.ktw.fly.ui.FLYMainActivity;
import com.ktw.fly.ui.base.BaseActivity;
import com.ktw.fly.ui.circle.range.AtSeeCircleActivity;
import com.ktw.fly.ui.circle.range.SeeCircleActivity;
import com.ktw.fly.ui.circle.util.SendTextFilter;
...
public class ShareLifeCircleActivity extends BaseActivity implements View.OnClickListener {
    ...
    private void initView() {
        ...
        mReleaseBtn.setText(getString(R.string.btn_public));
    }
    ...
    public void share() {
        ...
        mLoadFrame.setSomething(getString(R.string.back_app, mSKShareBean.getAppName()), new LoadFrame.OnLoadFrameClickListener() {
            ...
            public void confirmClick() {
                ShareBroadCast.broadcastFinishActivity(ShareLifeCircleActivity.this);
                startActivity(new Intent(ShareLifeCircleActivity.this, FLYMainActivity.class));
                finish();
            }
        });
        mLoadFrame.show();
