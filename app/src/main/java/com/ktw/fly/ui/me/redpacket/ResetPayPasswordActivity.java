...
import com.ktw.fly.ui.account.SelectPrefixActivity;
...
public class ResetPayPasswordActivity extends BaseActivity implements View.OnClickListener {
    ...
    private void resetPassword() {
        ...
        String mac = MAC.encodeBase64((FLYAppConfig.apiKey + coreManager.getSelf().getUserId() + accessToken + salt).getBytes(), smsKey);
                ...
                .execute(new BaseCallback<Void>(Void.class) {
                    ...
                    public void onResponse(ObjectResult<Void> result) {
                        ...
                        if (Result.checkSuccess(ResetPayPasswordActivity.this, result)) {
                            FLYApplication.getInstance().initPayPassword(coreManager.getSelf().getUserId(), 0);
