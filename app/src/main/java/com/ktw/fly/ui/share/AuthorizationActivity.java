...
import com.ktw.fly.bean.SKLoginBean;
import com.ktw.fly.bean.SKLoginResultBean;
...
public class AuthorizationActivity extends BaseActivity {
    ...
    private void verificationLogin() {
        ...
        String secret = Md5Util.toMD5(FLYAppConfig.apiKey + mSKLoginBean.getAppId() + coreManager.getSelf().getUserId() +
