...
public class ChatMessage extends AbstractMessage {
     ...
     * @return
     */
    public static ChatMessage toSocketMessage(com.ktw.fly.bean.message.ChatMessage message) {
        com.ktw.fly.bean.message.ChatMessage chatMessage = message.clone(false);
     ...
     * @return
     */
    public com.ktw.fly.bean.message.ChatMessage toSkMessage(String loginId) {
        com.ktw.fly.bean.message.ChatMessage chat = new com.ktw.fly.bean.message.ChatMessage();
