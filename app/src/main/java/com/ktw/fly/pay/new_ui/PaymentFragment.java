package com.ktw.fly.pay.new_ui;
...
import com.ktw.fly.ui.base.BaseLoginFragment;
...
public class PaymentFragment extends BaseLoginFragment {
    ...
    private void checkQrKey(PaymentActivity.Function<String> onSuccess, Runnable noQrCode) {
        ...
        String content = FLYAppConfig.apiKey + coreManager.getSelf().getUserId() + UserSp.getInstance(mContext).getAccessToken() + salt;
    ...
    private void updateQrImage(String code) {
        Bitmap bitmap1 = CommonUtils.createQRCode(code, DisplayUtil.dip2px(FLYApplication.getContext(), 160),
                DisplayUtil.dip2px(FLYApplication.getContext(), 160));
        Bitmap bitmap2 = CommonUtils.createBarCode(code, ScreenUtil.getScreenWidth(FLYApplication.getContext()) - DisplayUtil.dip2px(FLYApplication.getContext(), 40),
                DisplayUtil.dip2px(FLYApplication.getContext(), 80));
