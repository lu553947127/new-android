...
public class NewFriendMessage extends XmppMessage implements Cloneable, Serializable {
    ...
    public void parserJsonData(ChatMessage chatMessage) {
        this.userId = chatMessage.getFromUserId();
        this.nickName = chatMessage.getFromUserName();
        this.toUserId = chatMessage.getToUserId();
        this.toUserName = chatMessage.getToUserName();
        this.type = chatMessage.getType();
        this.timeSend = chatMessage.getTimeSend();
        this.content = chatMessage.getContent();
        this.packetId = chatMessage.getPacketId();
...
//        }
    ...
    public ChatMessage toChatMessage() {
        ...
        chat.setTimeSend(TimeUtils.sk_time_current_time());
        chat.setContent(this.content);
        chat.setPacketId(this.packetId);
