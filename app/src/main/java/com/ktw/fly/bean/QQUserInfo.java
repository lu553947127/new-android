    ...
    public String toString() {
        return
                "QQUserInfo{" +
                        ...
                        ",year = '" + year + '\'' +
                        ",level = '" + level + '\'' +
                        ",figureurl_2 = '" + figureurl2 + '\'' +
                        ",figureurl_1 = '" + figureurl1 + '\'' +
                        ",is_yellow_year_vip = '" + isYellowYearVip + '\'' +
                        ",province = '" + province + '\'' +
                        ",constellation = '" + constellation + '\'' +
                        ",figureurl = '" + figureurl + '\'' +
                        ",figureurl_type = '" + figureurlType + '\'' +
                        ",figureurl_qq = '" + figureurlQq + '\'' +
                        ",nickname = '" + nickname + '\'' +
                        ",yellow_vip_level = '" + yellowVipLevel + '\'' +
                        ",figureurl_qq_1 = '" + figureurlQq1 + '\'' +
                        ",vip = '" + vip + '\'' +
                        ",figureurl_qq_2 = '" + figureurlQq2 + '\'' +
                        "}";
    }
}
