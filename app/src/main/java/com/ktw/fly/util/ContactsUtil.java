...
public class ContactsUtil {
    ...
    public static Map<String, Contacts> getPhoneContacts(Context context) {
        ...
        try {
            ...
            int mobilePrefix = PreferenceUtils.getInt(FLYApplication.getContext(), Constants.AREA_CODE_KEY, 86);
    ...
    public static List<Contacts> getNewAdditionContacts(Context context, String userId) {
        ...
        // 取出本地联系人
        String string = PreferenceUtils.getString(FLYApplication.getContext(),
        ...
        // 更新本地联系人
        PreferenceUtils.putString(FLYApplication.getContext(),
