...
public class NoticeVoicePlayer {
    ...
    public NoticeVoicePlayer() {
        ...
        ringtone = initRingtone(FLYApplication.getContext());
        vibrator = (Vibrator) FLYApplication.getContext().getSystemService(VIBRATOR_SERVICE);
    }
    ...
    public void start() {
        ...
        // 判断该用户是否开启振动
        PrivacySetting privacySetting = PrivacySettingHelper.getPrivacySettings(FLYApplication.getContext());
