...
import com.ktw.bitbit.sp.LocationSp;

public class FLYBdLocationHelper {
    public static final String ACTION_LOCATION_UPDATE = FLYAppConfig.sPackageName + ".action.location_update";
    ...
    private BDLocationListener mMyLocationListener = new BDLocationListener() {
        ...
        public void onReceiveLocation(BDLocation location) {
            ...
            if (FLYAppConfig.DEBUG) {
                Log.d(FLYAppConfig.TAG, "百度定位信息  mLongitude:" + mLongitude + "  mLatitude:" + mLatitude + "  mAddressDetail:" + mAddress);
            }
            mLocationClient.stop();
    ...
    FLYBdLocationHelper(Context context) {
        mContext = context;
        // 获取上一次的定位数据
