...
public class BasicInfoWindow extends PopupWindow {
    ...
    public BasicInfoWindow(FragmentActivity context, OnClickListener itemsOnClick, Friend friend, User user) {
        ...
        reportTv = (TextView) mMenuView.findViewById(R.id.report_tv);
        setName.setText(FLYApplication.getInstance().getString(R.string.set_remark_name));
        addBlackList.setText(FLYApplication.getInstance().getString(R.string.add_blacklist));
        removeBlackList.setText(FLYApplication.getInstance().getString(R.string.remove_blacklist));
        delete.setText(FLYApplication.getInstance().getString(R.string.delete_friend));
        //设置按钮监听
