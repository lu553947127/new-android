package com.ktw.bitbit.view.window;
...
import com.ktw.bitbit.view.window.rom.RomUtils;
...
*/
    ...
    private boolean isRemoveAllView(int x1, int y1, int x2, int y2) {
        ...
        return radius <= DisplayUtil.dip2px(FLYApplication.getContext(), (float) (100 * Math.sqrt(2) + 200));
    }
