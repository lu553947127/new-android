        ...
        mGestureDetector = new GestureDetector(context,
                new SimpleOnGestureListener() {
                    ...
                    public boolean onSingleTapConfirmed(MotionEvent e) {
                        Intent intent = new Intent(com.ktw.bitbit.broadcast.OtherBroadcast.singledown);
                        FLYApplication.getInstance().sendBroadcast(intent);
                        return false;
                    }

                    @Override
                    public void onLongPress(MotionEvent e) {
                        Intent intent = new Intent(com.ktw.bitbit.broadcast.OtherBroadcast.longpress);
                        FLYApplication.getInstance().sendBroadcast(intent);
                    }
                });
