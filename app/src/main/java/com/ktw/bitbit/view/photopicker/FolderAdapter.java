package com.ktw.bitbit.view.photopicker;
...
public class FolderAdapter extends BaseAdapter {
    ...
    public View getView(int i, View view, ViewGroup viewGroup) {
        ...
        if (holder != null) {
            if (i == 0) {
                ...
                holder.size.setText(getTotalImageSize() + FLYApplication.getContext().getString(R.string.page));
                if (mFolders.size() > 0) {
                ...
                holder.name.setText(FLYApplication.getContext().getString(R.string.all_video));
                holder.size.setText(getVideoSize() + FLYApplication.getContext().getString(R.string.individual));
    ...
    class ViewHolder {
        ...
        void bindData(Folder data) {
            ...
            size.setText(data.images.size() + FLYApplication.getContext().getString(R.string.page));
            // 显示图片
