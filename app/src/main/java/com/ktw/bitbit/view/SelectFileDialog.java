...
import static com.ktw.bitbit.R.id.tv_group;
...
public class SelectFileDialog extends Dialog {
    ...
    public SelectFileDialog(Context context, OptionFileListener listener) {
        this(context, 0, LayoutInflater.from(context));
        mFileListener = listener;
    }

    private SelectFileDialog(Context context, int themeResId, LayoutInflater mInflater) {
    ...
    private void initView() {
        ...
        mBtn.setText(getContext().getString(R.string.confirm) + "(0)");
        mTextView.setText(getContext().getString(R.string.selected) + " 0B");

        mTabLayout.addTab(mTabLayout.newTab().setText(getContext().getString(R.string.video_audio)));
        mTabLayout.addTab(mTabLayout.newTab().setText(getContext().getString(R.string.pictures)));
        mTabLayout.addTab(mTabLayout.newTab().setText(getContext().getString(R.string.file)));
        mTabLayout.addTab(mTabLayout.newTab().setText(getContext().getString(R.string.application)));
        mTabLayout.addTab(mTabLayout.newTab().setText(getContext().getString(R.string.other)));
        setTextNormal(mTabLayout);
        // 按顺序排列，和tab顺序一致，
            ...
            public void onClick(View v) {
                if (mFileListener != null) {
                    ...
                    for (String key : opt.keySet()) {
                        list.add(opt.get(key).file);
                    }
                    mFileListener.option(list);
                    dismiss();
                }
            }
        });
    ...
    private void changeDataSource(Map<String, ArrayList> data) {
        ...
        // 还是空数据就弹Toast,
        if (cuttDatas.size() == 0) {
            Toast.makeText(mContext, getContext().getString(R.string.no_data_now), Toast.LENGTH_SHORT).show();
        }
    }
    ...
    class MyExpandableListView extends BaseExpandableListAdapter {
        ...
        public View getChildView(int groupPosition, final int childPosition, boolean isLastChild, View convertView, ViewGroup parent) {
            ...
            if (convertView == null) {
                ...
                holder.tvTime = (TextView) convertView.findViewById(R.id.tv_file_time);
            ...
            if (f != null) {
                ...
                holder.tvTime.setText(XfileUtils.fromatTime(f.lastModified(), "MM-dd HH:mm"));
                ...
                holder.linearLayout.setOnClickListener(new View.OnClickListener() {
                    ...
                    public void onClick(View v) {
                        ...
                        mBtn.setText(getContext().getString(R.string.upload) + "(" + opt.size() + ")");
                        mTextView.setText(getContext().getString(R.string.selected) + XfileUtils.fromatSize(cuttSize));
