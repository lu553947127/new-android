package com.ktw.bitbit.view.likeView;
...
public class LikeRelativeLayout extends RelativeLayout {
    ...
    public LikeRelativeLayout(Context context, @Nullable AttributeSet attrs) {
        super(context, attrs);
        initView(context);
    }

    public LikeRelativeLayout(Context context, @Nullable AttributeSet attrs, int defStyleAttr) {
