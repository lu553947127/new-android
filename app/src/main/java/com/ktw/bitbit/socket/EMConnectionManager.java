...
import com.ktw.bitbit.bean.event.EventLoginStatus;
...
import com.ktw.bitbit.socket.msg.AuthMessage;
import com.ktw.bitbit.socket.msg.AuthRespMessage;
import com.ktw.bitbit.socket.msg.ChatMessage;
import com.ktw.bitbit.socket.msg.ErrorMessage;
...
import com.ktw.bitbit.socket.msg.MessageReceiptStatus;
import com.ktw.bitbit.socket.msg.PingMessage;
import com.ktw.bitbit.socket.msg.PullBatchGroupMessage;
import com.ktw.bitbit.socket.msg.PullBatchGroupRespMessage;
import com.ktw.bitbit.socket.msg.SuccessMessage;
import com.ktw.bitbit.socket.protocol.Command;
import com.ktw.bitbit.socket.protocol.MessageProBuf;
import com.ktw.bitbit.socket.protocol.ProBufUtils;
import com.ktw.bitbit.socket.protocol.TcpPacket;
import com.ktw.bitbit.socket.protocol.TcpServerDecoder;
import com.ktw.bitbit.socket.protocol.TcpServerEncoder;
...
import com.ktw.bitbit.xmpp.NotifyConnectionListener;
import com.ktw.bitbit.xmpp.ReceiptManager;
import com.ktw.bitbit.xmpp.SendReceiptManager;
import com.ktw.bitbit.xmpp.SocketPingManager;
import com.ktw.bitbit.xmpp.XChatMessageListener;
import com.ktw.bitbit.xmpp.XMuChatMessageListener;
import com.ktw.bitbit.xmpp.listener.AuthStateListener;
import com.ktw.bitbit.xmpp.listener.ChatReceiptListener;
...
public class EMConnectionManager {
    ...
    public String SOCKET_HOST = "23.225.248.194";
