...
import com.ktw.bitbit.util.FileUtils;
...
public class AndroidDownloadManager {
    ...
    public void download() {
        ...
        //设置下载的路径
        File file = new File(FileUtils.getAdPath(), name);
    ...
    public static final String getFileNameByUrl(String url) {
        return System.currentTimeMillis() + getFileSuffixByUrl(url);
    }
     ...
     * @return
     */
    public static final String getFileSuffixByUrl(String url) {
