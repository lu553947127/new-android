...
public abstract class XmppMessage {
    ...
    public static final int TYPE_CUSTOM_EMOT = 11;//自定义表情
    public static final int TYPE_EMOT_PACKAGE = 12;//表情包表情
    ...
    // 本地协议
    public static final int TYPE_EXIT_ROOM = 0x8552;// 在线情况
    public static final int TYPE_JOIN_ROOM = 0x8553;// 在线情况
    ...
    public int getIsEncrype(JSONObject jObject) {
        return getIsEncrype(jObject, "isEncrypt");
    }

    public int getIsEncrype(JSONObject jObject, String key) {
