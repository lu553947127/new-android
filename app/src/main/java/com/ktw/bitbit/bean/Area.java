...
public class Area {
    ...
    public static Area getDefaultProvince() {// 获取默认的省份
        Area area = null;
        String provinceName = FLYApplication.getInstance().getBdLocationHelper().getProvinceName();
    ...
    public static Area getDefaultDistrict(int cityId) {// 获取默认的区县
        String districtName = FLYApplication.getInstance().getBdLocationHelper().getDistrictName();
