...
public class InviteVerifyActivity extends BaseActivity {
    ...
    private void initView() {
        ...
        AvatarHelper.getInstance().displayAvatar(message.getFromUserId(), mInviteAvatarIv);
        ...
        mVerifyGridView = (GridView) findViewById(R.id.verify_gd);
    ...
    private void inviteFriend() {
        ...
        HttpUtils.get().url(coreManager.getConfig().ROOM_MEMBER_UPDATE2)
                .params(params)
                .build()
    ...
    class VerifyAdapter extends CommonAdapter<Invite> {
        ...
        public View getView(int position, View convertView, ViewGroup parent) {
            ...
            AvatarHelper.getInstance().displayAvatar(data.get(position).getInvitedId(), mAvatarIv);
