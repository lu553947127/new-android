 ...
 */
@Deprecated
public class RedDetailsAuldActivity extends BaseActivity implements View.OnClickListener {
...
//                df.format(packetEntity.getMoney()));
    ...
    public void onClick(View v) {
        if (v.getId() == R.id.iv_title_left || v.getId() == R.id.red_back_tv) {
            ...
            Intent intent = new Intent(RedDetailsAuldActivity.this, RedListActivity.class);
