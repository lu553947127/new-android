        ...
        mAdapter.setmOnItemClickListener(new OnItemClickListener() {
            ...
            public void onItemClick(View view, int position) {
                ...
                if (!isEditOrSee) {
                    ...
                    intent.putExtra(FLYAppConstant.EXTRA_IMAGE_URI, C.getUrl());
                ...
                .execute(new BaseCallback<Collectiion>(Collectiion.class) {
                    ...
                    public void onResponse(ObjectResult<Collectiion> result) {
                        ...
                        if (result.getResultCode() == 1) {
                            ...
                            mReadyData.clear();
                            updateUI();
                            ManagerEmojiActivity.this.sendBroadcast(new Intent(com.ktw.bitbit.broadcast.OtherBroadcast.CollectionRefresh));
                        }
                    }
