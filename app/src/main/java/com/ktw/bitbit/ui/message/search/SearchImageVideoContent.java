...
import com.ktw.bitbit.ui.message.ChatOverviewActivity;
...
//                    intent.putExtra("imageChatMessageList", JSON.toJSONString(imageList));
                    ...
                    intent.putExtra(FLYAppConstant.EXTRA_VIDEO_FILE_PATH, (!TextUtils.isEmpty(chatMessage.getFilePath()) && FileUtil.isExist(chatMessage.getFilePath())) ?
