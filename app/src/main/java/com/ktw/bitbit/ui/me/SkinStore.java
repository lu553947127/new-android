...
import com.ktw.bitbit.ui.base.BaseRecAdapter;
import com.ktw.bitbit.ui.base.BaseRecViewHolder;
import com.ktw.bitbit.util.RecyclerSpace;
...
public class SkinStore extends BaseActivity {
    ...
    public class SkiinViewHolder extends BaseRecViewHolder implements View.OnClickListener {
        ...
        public void onClick(View v) {
            ...
            FLYMainActivity.isInitView = true;
            Intent intent = new Intent(SkinStore.this, FLYMainActivity.class);
