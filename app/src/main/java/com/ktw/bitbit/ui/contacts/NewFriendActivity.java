...
import com.ktw.bitbit.adapter.NewFriendAdapter;
...
public class NewFriendActivity extends BaseActivity implements NewFriendListener {
    ...
    private void goTalkHistoryActivity(NewFriendMessage mNewFriendMessage) {
        ...
        intent.putExtra(FLYAppConstant.EXTRA_USER_ID, mNewFriendMessage.getUserId());
        intent.putExtra(FLYAppConstant.EXTRA_NICK_NAME, mNewFriendMessage.getNickName());
