...
import com.ktw.bitbit.bean.RoomMessage;
                ...
                case 1:
                    if (msg.obj != null) {
                        ...
                        handler.postDelayed(() -> {
                            ...
                            intent.putExtra(FLYAppConstant.EXTRA_USER_ID, roomMessage.getData().getJid());
                            intent.putExtra(FLYAppConstant.EXTRA_NICK_NAME, roomMessage.getData().getNickname());
