    ...
    private void initView() {
                        ...
                        .execute(new BaseCallback<Void>(Void.class) {
                            ...
                            public void onResponse(ObjectResult<Void> result) {
                                ...
                                if (Result.checkSuccess(ChangePayPasswordActivity.this, result)) {
                                    ...
                                    // 记录下支付密码已经设置，
                                    FLYApplication.getInstance().initPayPassword(coreManager.getSelf().getUserId(), 1);
                                }
                                finish();
                            }
                            ...
                            public void onError(Call call, Exception e) {
                                FLYReporter.post("修改支付密码接口调用失败，", e);
                                DialogHelper.dismissProgressDialog();
        ...
        passwordInputView.addTextChangedListener(new TextWatcher() {
            ...
            public void afterTextChanged(Editable psw) {
                if (psw.length() == FLYAppConstant.PASS_WORD_LENGTH) {
                    if (needOldPassword) {
