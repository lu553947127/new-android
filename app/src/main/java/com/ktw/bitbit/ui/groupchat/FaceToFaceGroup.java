...
import com.ktw.bitbit.ui.message.HandleActivityDestroyedDoSomeThing;
                ...
                .execute(new BaseCallback<MucRoom>(MucRoom.class) {
                    ...
                    public void onResponse(ObjectResult<MucRoom> result) {
                        if (result.getResultCode() == 1 && result.getData() != null) {
                            ...
                            Friend friend = FriendDao.getInstance().getFriend(mucRoom.getUserId(),mucRoom.getJid());
                            if(friend == null){
                                friend = new Friend();
                                friend.setOwnerId(mucRoom.getUserId());
