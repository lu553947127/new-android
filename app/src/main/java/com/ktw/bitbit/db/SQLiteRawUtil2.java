...
public class SQLiteRawUtil2 {
    ...
    public static String getCreateRoomMemberTableSql(String tableName) {
        String sql = "CREATE TABLE IF NOT EXISTS "
                + tableName
                + " (_id INTEGER PRIMARY KEY AUTOINCREMENT,roomId VARCHAR,userId VARCHAR,userName VARCHAR,cardName VARCHAR,role INTEGER,createTime INTEGER,inviterId VARCHAR,inviterName VARCHAR)";
        return sql;
    }
