...
public class AreasDao {
    ...
    private AreasDao() {
        try {
            dao = DaoManager
                    .createDao(OpenHelperManager.getHelper(FLYApplication.getInstance(), SQLiteHelper.class).getConnectionSource(), Area.class);
...

    {
        ...
        mDefaultAreas.setName(FLYApplication.getInstance().getString(R.string.unknown));
    }
