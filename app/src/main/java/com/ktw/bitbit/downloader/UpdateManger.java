...
public class UpdateManger {
    ...
    // 提示消息
    private String updateMsg = FLYApplication.getContext().getString(R.string.new_apk_download);
    // 下载安装包的网络路径
    ...
    public void checkUpdateInfo(String serviceVersionCode, String apkUrls,String remark ) {//添加检查服务器更新的代码
        ...
        com.blankj.utilcode.util.LogUtils.e("mCurrentVersionCode" + mCurrentVersionCode);
        com.blankj.utilcode.util.LogUtils.e("serviceVersionCode" + serviceVersionCode);
    ...
    private String getStringById(int sid) {
        return FLYApplication.getContext().getString(sid);
    }
    ...
    private void showNoticeDialog(String desc, String title) {
        ...
        builder.setPositiveButton(FLYApplication.getContext().getString(R.string.download), new DialogInterface.OnClickListener() {
            @Override
            public void onClick(DialogInterface dialog, int which) {
                ...
                try {
                    ...
                    FLYReporter.unreachable(t);
                    callNoUpdate();
                }
            }
        });
//        builder.setNegativeButton(FLYApplication.getContext().getString(R.string.cancel), new DialogInterface.OnClickListener() {
//            @Override
//            public void onClick(DialogInterface dialog, int which) {
//                dialog.dismiss();
//            }
//        });
    ...
    protected void showDownloadDialog() {
        ...
        builder.setMessage("下载安装中，请不要离开此页面");
