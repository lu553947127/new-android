...
public class MsgBroadcast {
    public static final String ACTION_MSG_UI_UPDATE = FLYAppConfig.sPackageName + ".action.msg_ui_update";// 消息界面的更新
    public static final String ACTION_MSG_UI_UPDATE_SINGLE = FLYAppConfig.sPackageName + ".action.msg_ui_update_single";// 消息界面的更新
    public static final String ACTION_MSG_NUM_UPDATE = FLYAppConfig.sPackageName + ".intent.action.msg_num_update";// 未读数量的更新
    public static final String ACTION_MSG_NUM_UPDATE_NEW_FRIEND = FLYAppConfig.sPackageName + ".intent.action.msg_num_update_new_friend";// 新的朋友 未读数量的更新
    public static final String ACTION_MSG_NUM_RESET = FLYAppConfig.sPackageName + ".action.msg_num_reset";// 未读数量需要重置，即从数据库重新查
    ...
    public static final String ACTION_MSG_STATE_UPDATE = FLYAppConfig.sPackageName + ".action.CHANGE_MESSAGE_STATE"; // 通知某条消息改变

    public static final String ACTION_DISABLE_GROUP_BY_SERVICE = FLYAppConfig.sPackageName + ".action.disable_group_by_service"; // 群组被锁定/解锁
    public static final String ACTION_FACE_GROUP_NOTIFY = FLYAppConfig.sPackageName + ".action.face_group_notify"; // 面对面建群界面广播
    public static final String EXTRA_OPERATING = "EXTRA_OPERATING";

    public static final String ACTION_MSG_UPDATE_ROOM = FLYAppConfig.sPackageName + ".action.msg_room_update"; // 聊天群组界面的更新
    public static final String ACTION_MSG_ROLE_CHANGED = FLYAppConfig.sPackageName + ".action.ROLE_CHANGED";
    public static final String ACTION_MSG_UPDATE_ROOM_GET_ROOM_STATUS = FLYAppConfig.sPackageName + ".action.msg_room_update_get_room_status"; // 聊天群组界面的更新并调用群属性接口
    public static final String ACTION_MSG_CLOSE_TRILL = FLYAppConfig.sPackageName + ".action.colse_trill"; // 关闭抖音模块
    public static final String ACTION_MSG_UPDATE_ROOM_INVITE = FLYAppConfig.sPackageName + ".action.msg_room_update_invite"; // 群组信息界面更新允许群成员邀请好友，
