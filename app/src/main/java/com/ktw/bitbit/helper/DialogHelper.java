...
import com.ktw.bitbit.ui.dialog.SingleInputDialogView;
import com.ktw.bitbit.ui.dialog.TowInputDialogView;
import com.ktw.bitbit.util.ToastUtil;
import com.ktw.bitbit.view.CustomizeProgressDialog;
...
public class DialogHelper {
    ...
    public static InputFilter mExpressionFilter = new InputFilter() {
        ...
        public CharSequence filter(CharSequence source, int start, int end, Spanned dest, int dstart, int dend) {
            ...
            if (emojiMatcher.find()) {
                Toast.makeText(FLYApplication.getContext(), R.string.tip_not_support_emoji, Toast.LENGTH_SHORT).show();
                return "";
            }
            return null;
        }
    ...
    public static InputFilter mChineseEnglishNumberFilter = new InputFilter() {
        ...
        public CharSequence filter(CharSequence charSequence, int i, int i1, Spanned spanned, int i2, int i3) {
            ...
            if (!matcher.find()) {
                ...
                Toast.makeText(FLYApplication.getContext(), R.string.tip_chinese_english_number, Toast.LENGTH_SHORT).
                        show();
                return "";
            }
        }
    ...
    public static void tipDialog(Context context, String tip) {
    ...
    public static VerifyDialog inputNumber(Context ctx, String title, String hint, VerifyDialog.VerifyClickListener listener) {
        VerifyDialog dialog = new VerifyDialog(ctx);
        dialog.setVerifyClickListener(title, hint, listener);
        dialog.setOkButton(android.R.string.ok);
