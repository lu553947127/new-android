...
public class FileUtil {
    ...
    private static String getPublicFilePath(int type) {
        ...
        switch (type) {
            case TYPE_ADUIO:
                fileDir = FLYApplication.getInstance().mVoicesDir01;
                fileSuffix = ".mp3";
                break;
            case TYPE_VIDEO:
                fileDir = FLYApplication.getInstance().mVideosDir01;
                fileSuffix = ".mp4";
                break;
            case TYPE_IMAGE:
                fileDir = FLYApplication.getInstance().mPicturesDir01;
                fileSuffix = ".jpg";
                break;
        }
        if (fileDir == null) {
    ...
    public static String getRandomAudioFilePath() {
        String userId = CoreManager.requireSelf(FLYApplication.getInstance()).getUserId();
        if (userId != "") {
